...
//    single_job_row.append('<div class="small-6 column"><p>' + job.ID + " &mdash; " + job.PluginName + '<br>' +
//            ' [<a target="_blank" href="' + job.data_url + '">raw data</a>]' +
//            ' [<a target="_blank" href="' + job.visualised_data_url + '">visualized data</a>]' +
//            ' [<a target="_blank" href="' + job.status_url + '">details</a>]' +
//            '</p></div>');
//    single_job_row.append('<div class="small-1 column"><p>' + job.Executions_num + '</p></div>');
//    single_job_row.append('<div class="small-1 column"><p>' + job.Status + '</p></div>');
////    single_job_row.append('<div class="small-2 column"><p>' + job.WhenCreated_as_string + '</p></div>');
////    single_job_row.append('<div class="small-2 column"><p>' + job.WhenLastrun_as_string + '</p></div>');
//
